...
DATE pfsense dhcpd: uid lease RANDOM_IP for client RANDOM_MAC is duplicate on RANDOM_IP/24+\
DATE pfsense dhcpd: DHCPREQUEST for RANDOM_IP from RANDOM_MAC via igb1+\
DATE pfsense dhcpd: DHCPACK on RANDOM_IP to RANDOM_MAC via igb1"
